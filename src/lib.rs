...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting WhaleAlert processing");
    
    let mut processor = WhaleAlertProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = WhaleAlertProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = WhaleAlertProcessor::new(false);
